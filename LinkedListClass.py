...
class LinkedList:
    """Метод инициализации связанного списка"""
    def __init__(self):
        self.head = None
    ...
    """Метод удаления элемента списка под определенной позицией"""
    ...
    """Метод добавления элемента списка под определенной позицией"""
    ...
    """Метод вывода всех данных списка"""
    def print_ll(self):
        current_node = self.head
        while current_node:
    ...
    """Метод получения элемента списка по его данным списка"""
    def get(self, data):
        current_node = self.head
        while current_node:
